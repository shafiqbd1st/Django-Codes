...
class studentData(forms.Form):
    ...
    age = forms.IntegerField(validators=[validators.MaxValueValidator(35, message="Age must be maximum 35"), validators.MinValueValidator(30, message="Age must be minimum 20")])